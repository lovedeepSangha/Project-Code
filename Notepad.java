...
{
JOptionPane.showMessageDialog(Notepad.this.f,aboutText,"Advance Notepad!",JOptionPane.INFORMATION_MESSAGE);
}
else
...
final String aboutText=
	"<html><big>Your Advance Notepad</big>"
	+"<p align=right>Prepared by a BhartJeet & Harsimran"
   +"<hr><p align=center>Think Thoda Hatt Kai<br>"
