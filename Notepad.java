...
class FileOperation {
	...
	boolean newFileFlag;
	String fileName;
	String applicationTitle = "Advance Notepad";
...
public class Notepad implements ActionListener, MenuConstants {
	...
	public void actionPerformed(ActionEvent ev) {
		...
		////////////////////////////////////
			...
			JOptionPane.showMessageDialog(Notepad.this.f, aboutText, "Advance Notepad!",
					JOptionPane.INFORMATION_MESSAGE);
		} else if (cmdText.equals(SpeechEnable)) {
			new Thread(() -> {
				try {
		...
		else if (cmdText.equals(Speechdisable)) {
			mic.close();
	...
	void createMenuBar(JFrame f) {
		...
		JMenu Speech2Text = createMenu(Speech, KeyEvent.VK_EQUALS, mb);
		...
		createMenuItem(SpeechEnable, KeyEvent.VK_EQUALS, Speech2Text, this);

		createMenuItem(Speechdisable, KeyEvent.VK_EQUALS, Speech2Text, this);
...
interface MenuConstants {
	...
	final String Speech = "Speech2Text";
	...
	final String SpeechEnable = "Enable";
	final String Speechdisable = "Disable";
	...
	final String aboutText = "<html><big>Your Advance Notepad</big>"
			+ "<p align=right>Prepared by a BhartJeet & Harsimran" + "<hr><p align=center>Think Thoda Hatt Kai<br>"
			// +"<strong>Thanx 4 using Javapad</strong><br>"
			// +"Ur Comments as well as bug reports r very welcome at<p align=center>"
			+ "<hr><em><big>Bhartjeet01@icloud.com</big></em><hr><html>";
}